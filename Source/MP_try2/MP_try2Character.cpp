...
{
	// If MP_try2 is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in MP_try2.Build.cs is not automatically propagated
